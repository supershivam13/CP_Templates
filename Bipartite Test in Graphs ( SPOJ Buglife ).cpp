...
int visited[1000001], col[1000001];
vi v[1000001];
...
int32_t main()
{
    ...
    w(t) {
        ...
        bool ans = true;
        for (int i = 1; i <= n; i++) {
            if (visited[i] == 0 and !dfs(i, 0)) {
                ans = false;
            }
        }
 
        if (ans) {
            cout << "Scenario #" << tc << ":" << endl << "No suspicious bugs found!" << endl;
        }
        else
            cout << "Scenario #" << tc << ":" << endl << "Suspicious bugs found!" << endl;
