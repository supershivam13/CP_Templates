...
// For Graph questions, globally initialised visited array and adjacency list with zeroes.
int visited[1000001];
vi v[1000001];

// Array to store subtree size of each node
// subtreeszie[node] represents the size of substree at node
int subtreeszie[1000001];
