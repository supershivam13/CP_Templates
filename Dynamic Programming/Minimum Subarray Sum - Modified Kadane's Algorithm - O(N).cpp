...
// MODIFIED KADANE'S ALGORITHM - FOR FINDING THE MINIMUM SUBARRAY SUM OF AN ARRAY

// ( Only we change the signs of the elements of the input array, then apply the normal KADANE'S Algo
// to find the maximum subarray sum and then return the result with a negative sign )
...
int32_t main()
{
    ...
    // Invert  the answer to get minimum value
